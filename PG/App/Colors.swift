...
extension SKColor {
	...
	static var graySurface: SKColor { .hex(0xAFAFAF) }

	static var blueSurface: SKColor { .hex(0x5AAAEE) }
	static var yellowSurface: SKColor { .hex(0xF1D04B) }
	static var redSurface: SKColor { .hex(0xD5493F) }
