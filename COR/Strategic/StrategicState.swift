...
/// `f` forest, `F` forest hill, `.` field. Forests follow the real
/// vegetation belts:
...
/// and open steppe from central Ukraine eastward. Wooded uplands are forest
/// hills — the taiga slopes east of the Scandinavian spine, the Valdai
/// ridges, Småland, the German uplands and Sudetes, the Alpine foothills,
/// and the Carpathian arc — while hills above or beyond the treeline stay
/// bare: the Lapland and Kola fells, the Norwegian high plateaus, and the
/// farmed Central Russian Upland.
...
.....n^^Ffffff..ffffffffffffffff
...fn^^^Ffff...ffffffffffFFfffff
..fn^^^Fffff...fffffffffFFFfffff
..ff^^^Fffff....fffffffffFffffff
..ffnnnffffff........ff.fff.ffff
...nn..ffffff...f.fff.fff.fff.ff
.......fFFff.....ff.fff.fff.fff.
